...
/**
 * Reference usage for `PathDrawingPortfolioHero`.
 *
 * Not routed — render it from a page to see the component. The hero paints no
 * background of its own, so the backdrop belongs on the wrapper, as below.
 */
