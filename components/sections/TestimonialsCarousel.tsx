...
export function TestimonialsCarousel({ testimonials }: { testimonials: TestimonialItem[] }) {
        ...
        <div className="mx-auto mt-12 max-w-[820px] text-center">
          ...
          */}
          ...
          >
            ...
            <p className="mt-5 text-card">{testimonial.authorName}</p>
            <p className="mt-1 text-[0.9375rem]">{testimonial.city}</p>
