            ...
            >
              {category.imageUrl ? (
                <Image
                  ...
                  className="object-cover transition-transform duration-500 ease-subtle group-hover:scale-105"
                />
              ) : (
                ...
                <div
                  ...
                  className="absolute inset-0 bg-[linear-gradient(135deg,theme(colors.brass.tint)_0%,theme(colors.surface.alt)_45%,theme(colors.brass.soft)_100%)]"
                />
              )}
              {/*
